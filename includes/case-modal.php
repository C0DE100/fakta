        ...
        <div class="modal-box modal-box--wide modal-box--xwide modal-scroll" role="dialog" aria-modal="true">
            <div class="modal-header">
                ...
                <div class="modal-header-actions">
                    <button type="button" id="caseMinimize" class="modal-close" title="Сокриј (зачувано како нацрт)" aria-label="Сокриј како нацрт">
                ...
                <section class="case-block">
                    ...
                    <div class="case-subgroup">
                        <div class="case-subhead">
                            <div>
                                <span class="case-subhead-title case-subhead-title--client">Наша странка</span>
                    ...
                    <div class="case-subgroup">
                        <div class="case-subhead">
                            <div>
                                <span class="case-subhead-title case-subhead-title--opponent">Спротивна странка</span>
